...
try:
    while True:
        ...
        results = model.predict(source=color_image, show=False, conf=0.6, half=False)  # Set show to False  
        ...
        for i, res in enumerate(recent_results):  # Iterate over the sorted results
            table = sd.getSubTable(f"Object{i}")  # Create a new sub-table for each object
